<template>
  <section class="contacts">
    <div class="bg-cover">
      <div class="flex justify-center max-w-4xl mx-auto my-1 lg:my-1">
        <!--Main Col-->
        <div
          id="profile"
        ...
        >
          ...
          >
            <a
              target="_blank"
              class="link"
              href="https://www.facebook.com/nspbdz/"
              data-tippy-content="@facebook_handle"
              ><svg
                class="h-6 text-gray-600 fill-current hover:text-teal-700"
                role="img"
                viewBox="0 0 24 24"
